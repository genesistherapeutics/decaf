...
cache_dir = Path(os.environ.get("BOLTZ_CACHE_DIR", "/path/to/boltz-cache"))
ccd_path = cache_dir / "ccd.pkl"
moldir = cache_dir / "mols"
with ccd_path.open("rb") as file:
    ccd = pickle.load(file)

_results_root = Path(os.environ.get("RESULTS_ROOT", "/path/to/results"))
boltz1_dir = _results_root / "boltz/predictions"
boltz1x_dir = _results_root / "boltz_1x/predictions"
chai_dir = _results_root / "chai"
af3_dir = _results_root / "af3"
